...
const FeatureCard = ({ feature, className }: FeatureCardProps) => (
  ...
  >
    ...
    <div className="relative xl:h-[80%] md:h-[90%] mt-auto p-6 flex flex-col justify-end z-10 max-w-[33rem] w-full">
      <h3 className="text-3xl md:text-4xl lg:text-[16px] xl:text-5xl font-anton font-normal text-white tracking-tight mb-3">
        {feature.title}
      </h3>
      <p className="text-normal md:text-xl lg:text-base xl:text-normal text-white font-mono leading-[1.2rem]">
        {feature.description}
      </p>
    </div>
  </div>
