...
import { idlFactory } from './wavv_website.did.js';
export { idlFactory } from './wavv_website.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WAVV_WEBSITE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wavv_website.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wavv_website canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wavv_website.did.js")._SERVICE>}
 */
export const wavv_website = createActor(canisterId);
